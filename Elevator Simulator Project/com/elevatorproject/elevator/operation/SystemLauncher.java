...
class SystemLauncher {
	...
	public static void main(String[] args) {
		SystemLauncher.building = BuildingFactory.buildBuilding(11, 3, 12, 2);
		PassengerGenerator passengerGenerator = PassengerGeneratorFactory.buildPassengerGenerator(com.nodalexchange.elevator.operation.SimplePassengerGenerator.class.getName());
		ElevatorController controller = ElevatorControllerFactory.buildController(com.nodalexchange.elevator.controllers.ElevatorController.class.getName());
		int totalPassengerGenerationCycles = 2;
